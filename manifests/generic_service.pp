# Define keystone::generic_service
#
# This class implements basic ceilomer services.
# It is derived from https://github.com/stackforge/puppet-keystone/blob/master/manifests/generic_service.pp
#
define keystone::generic_service (
